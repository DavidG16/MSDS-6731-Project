...
train_data_q2 = train_data_q2 %>% select(Id, GrLivArea, Neighborhood, LotArea, YrSold, SaleCondition, HouseStyle, KitchenQual, YearRemodAdd,GarageCars, PoolArea, Fireplaces,BsmtFullBath,BsmtHalfBath,FullBath,HalfBath,BedroomAbvGr,Remodel,OverallQual,  GrLivArea2, SalePrice)
...
test_data_q2 = test_data_q2 %>% select(Id, GrLivArea, Neighborhood, LotArea, YrSold, SaleCondition, HouseStyle, KitchenQual, YearRemodAdd,GarageCars, PoolArea, Fireplaces,BsmtFullBath,BsmtHalfBath,FullBath,HalfBath,BedroomAbvGr,Remodel,OverallQual,  GrLivArea2)
